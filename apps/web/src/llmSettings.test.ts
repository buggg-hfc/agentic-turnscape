...
import { clearLlmSettings, loadLlmSettings, saveLlmSettings, type StorageLike } from "./llmSettings.js";
...
describe("LLM settings persistence", () => {
  ...
  it("clears saved local configuration", () => {
    const storage = new MemoryStorage();
    saveLlmSettings({ baseUrl: "http://localhost:11434/v1", model: "local", apiKey: "x", timeoutMs: 12000 }, storage);
